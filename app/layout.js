...
export default function RootLayout({ children }) {
  ...
  <div className="container mx-auto px-4">
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 text-gray-200 dark:text-gray-300">
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-3 text-sm">
          <li><a href="/faq" className="hover:text-gray-300 transition-all">FAQs</a></li>
          <li><a href="/help" className="hover:text-gray-300 transition-all">Help Center</a></li>
  ...
  {/* LinkedIn */}
  <a
    href="https://www.linkedin.com/in/ishaan-mittal29"  // Your LinkedIn profile URL
    className="text-white hover:text-gray-300 transition-transform transform hover:scale-125"
    aria-label="LinkedIn"
    target="_blank" // Open in a new tab
    rel="noopener noreferrer" // Security best practice
